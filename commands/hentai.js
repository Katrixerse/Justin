...
exports.run = async (client, message) => {
    ...
    try {
        const { body } = await request
            .get('https://www.reddit.com/r/AnimeHentaiGifs.json?sort=top&t=week')
            .query({
                limit: 800
            });
        ...
        const embed = new Discord.RichEmbed()
            ...
            .setFooter("Images provided by r/AnimeHentaiGifs")
...
exports.help = {
    name: 'hentai',
    description: 'Gets a random image off of r/AnimeHentaiGifs.',
    usage: 'hentai'
};