...
exports.run = async (client, message) => {
    ...
    try {
        const { body } = await request
            .get('https://www.reddit.com/r/naughtyinpublic.json?sort=top&t=week')
            .query({
                limit: 800
            });
        ...
        const embed = new Discord.RichEmbed()
            ...
            .setFooter("Images provided by r/naughtyinpublic")
...
exports.help = {
    name: 'public',
    description: 'Gets a random image off of r/naughtyinpublic.',
    usage: 'public'
};